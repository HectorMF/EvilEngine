...
public class TestScript extends Script{
	...
	public void onUpdate() {
		...
		if(count < 30){
			...
			e.addComponent(body); 
			e.addComponent(new Transform().setPosition(count/5*50, 400, 10).setDimension(100, 100, 10)); 
			e.addComponent(new Renderable(test,world.getRenderSystem().getLayer(0))); 
			e.addToWorld();
		}
