...
public abstract class ScriptableComponent<T extends Delegate> extends Component {
	...
	protected static HashMap<Class<? extends Delegate>, Class<? extends ScriptableComponent<? extends Delegate>>> delegateMapping = new HashMap<Class<? extends Delegate>, Class<? extends ScriptableComponent<? extends Delegate>>>();
	...
	public ScriptableComponent(
			Class<? extends ScriptableComponent<T>> componentType,
